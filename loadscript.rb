...
HTTParty.post("http://sifd-staging-03.kb.dk/", body: {user: {email: 'user1@example.com', password: 'secret'}}).body
...
class Partay
  include HTTParty
  base_uri 'http://sifd-staging-03.kb.dk'
end
...
pp Partay.post('/pears.json', options)